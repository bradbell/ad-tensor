...
// END_BINARY
{
    ...
    switch(op_enum) {
        ...
        //
        default:
        assert( false && "adten_t::binary: invalid value for op_enum");
    }
    //
    // tape
    ...
    //
    // res_adtype
    adtype_t res_adtype = std::max( lhs.m_adtype, rhs.m_adtype );
    //
    // res_tape_id
    ...
    if(res_adtype == adtype_t::constant ) {
        ...
        tape.m_con_vec.push_back( res_at_ten.clone() );
    } else {
        //
        // agraph
        ...
        agraph->m_arg_type.push_back( lhs.m_adtype );
        //
