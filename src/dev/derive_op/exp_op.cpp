...
namespace ad_tensor { namespace dev {
    ...
    void exp_op_t<TensorType>::forward_par(
        ...
        //
        // par_vec
        par_vec[op_index] = par_vec[operand_index].exp();
    }
    ...
    void exp_op_t<TensorType>::forward_var(
        ...
        //
        // var_vec
        var_vec[op_index] = var_vec[operand_index].exp();
    }
    ...
    void exp_op_t<TensorType>::forward_der(
        ...
        // for_der
        for_der[op_index] = for_der[operand_index] * var_vec[op_index];
    }
    ...
    void exp_op_t<TensorType>::reverse_der(
        ...
        if( ! rev_der[operand_index].defined() ) {
            rev_der[operand_index]  = var_vec[op_index] * rev_der[op_index];
        } else {
            rev_der[operand_index] += var_vec[op_index] * rev_der[op_index];
        }
    }
